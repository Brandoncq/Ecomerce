      ...
      <section className="w-full flex">
        <div className="relative w-full h-lvh flex flex-col max-md:text-sm">
          <div className="relative w-full h-[72%] flex">
            <img
              src="https://images.unsplash.com/photo-1608511271453-7b293dc27bce?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt=""
          ...
          <div className="w-full h-[28%] flex justify-center items-start py-6 md:px-20 text-center">
            <div
            ...
            >
              <p className="group-hover:text-zinc-700">Acerca de Nosotros</p>
              <svg
                ...
                className="w-16 h-16 mt-10 group-hover:fill-zinc-700"
              >
            ...
            >
              <p className="group-hover:text-zinc-700">
      ...
      <section className="w-full flex flex-col">
        ...
        >
          ...
          <div className="w-full xl:w-1/2 flex items-center justify-center max-md:my-4 max-md:order-last">
            <img
              src="https://images.unsplash.com/photo-1614179924047-e1ab49a0a0cf?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt=""
        ...
        >
          ...
          <div className="w-full xl:w-1/2 max-xl:my-4 md:pl-10 flex flex-col justify-center items-center text-center text-sm md:text-base lg:text-sm md:px-5">
            <h2 className="text-black text-4xl font-semibold my-4">
              Nuestro Equipo y Propósito
            </h2>
            <p className="my-2">
