    ...
    <div className="w-full flex flex-col">
      <section className="w-full flex">
        <div className="w-full h-32 flex justify-center items-center relative">
          ...
          <img
            src="https://images.unsplash.com/photo-1547483238-2cbf881a559f?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
