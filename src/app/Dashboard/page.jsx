...
function Dashboard() {
  ...
  const descargarPDF = () => {
    ...
    html2canvas(modalContent).then((canvas) => {
      ...
      // Calcular las proporciones para que el contenido encaje en el PDF
        ...
        >
          <div className="bg-white p-3 rounded-lg w-11/12 md:w-3/4 xl:w-2/5 flex flex-col justify-center items-center">
            ...
            >
              ...
              <div className="max-md:text-sm flex md:space-x-4 space-x-3">
                <p>
            ...
            <div className="md:p-2 flex justify-center items-center space-x-2">
              ...
              <button
                ...
                className="bg-slate-500 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded-lg mt-4"
              >
                Descargar PDF
              </button>
              <button
