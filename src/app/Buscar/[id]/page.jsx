            ...
            <div className="w-full md:w-1/2 p-2 flex flex-col justify-center">
              ...
              {producto.stock > 0 && (
                <>
                  ...
                  <button
                    className="flex justify-center items center bg-zinc-800 hover:border-zinc-800 rounded-md text-sm lg:text-lg font-semibold hover:bg-zinc-200 transition-all duration-300 ease-in-out max-xl:w-full max-xl:mt-2 border-2"
