...
export default function Buscador({ params }) {
  ...
  return (
    <div className="w-full flex flex-col border-t-4 border-zinc-200 min-h-[calc(100vh-7rem)]">
        ...
        {productos.map((producto, index) => (
          ...
          >
            <div className="w-full md:w-1/2 p-2 flex flex-col justify-center">
              ...
              <h3 className="text-xl md:text-3xl mb-1">
              ...
              <h2 className="text-3xl md:text-5xl font-semibold my-2">
                {producto.stock > 0 ? (
              ...
              {producto.stock > 0 && (
                <>
                  ...
                  <div className="w-full flex justify-center items-center">
                    <div className=" xl:w-2/3 max-xl:w-full flex">
                      <button
                        className="flex justify-center items center bg-zinc-800 hover:border-zinc-800 rounded-md text-sm lg:text-lg font-semibold hover:bg-zinc-200 transition-all duration-300 ease-in-out w-full max-xl:mt-2 border-2"
