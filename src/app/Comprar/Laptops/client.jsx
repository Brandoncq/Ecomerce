...
export default function ClientLaptops() {
  ...
  return (
    <div className="w-full flex flex-wrap">
      ...
      <div className="w-full lg:w-1/4 p-4 lg:sticky lg:top-5 md:px-5 flex flex-wrap max-lg:border-b-4 max-lg:border-zin-800">
        <div className="lg:hidden w-full flex justify-end items-center">
          <div
            className="w-8 h-8 flex justify-center items-center hover:bg-slate-400"
            onClick={() => {
              setmenu(!menuopen);
            }}
          >
        ...
        <div className={`w-full ${menuopen ? "block" : "max-lg:hidden"}`}>
