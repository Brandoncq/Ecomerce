    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center w-full my-1">
        <div className="flex max-xl:flex-col items-center justify-between w-full">
          ...
          <button
            className="flex flex-1 justify-center items center p-3 bg-zinc-800 text-white border-2 hover:text-zinc-800 hover:border-zinc-800 rounded-md text-sm lg:text-lg font-semibold lg:ml-1 hover:bg-zinc-200 transition-all duration-300 ease-in-out max-xl:w-full max-xl:mt-2"
