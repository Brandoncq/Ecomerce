        ...
        {options.map((limit) => (
          <li key={limit}>
            <a
              ...
              className="flex items-center justify-center px-3 h-8 leading-tight text-white border-l border-gray-300 hover:bg-gray-100 hover:text-black cursor-pointer"
            >
              {limit}
            </a>
          </li>
