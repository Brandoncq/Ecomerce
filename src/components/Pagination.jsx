      ...
      <ul className="inline-flex -space-x-px text-xl p-2 w-full justify-center">
        <li>
          <a
            ...
            className="flex items-center justify-center px-3 h-8 leading-tight text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 cursor-pointer"
          >
